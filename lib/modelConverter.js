...
class ModelConverter {
    ...
    setModel(oModel) {
        if (oModel instanceof ModelRenderer) {
            this._model = oModel;
        } else {
            this._model = new ModelRenderer(oModel);
        }
    ...
    /**Alternative start
        27 -11 0       Routing -Simple
        27 -29 0       Routing -MasterDetail
        27 -30 0       Routing -FlexibleColumnLayout
        11 29 30 -27 0 Simple MasterDetail FlexibleColumnLayout -Routing
        -11 -29 0      -Simple -MasterDetail
        -11 -30 0      -Simple -FlexibleColumnLayout
        -29 -30 0      -MasterDetail -FlexibleColumnLayout
        Alternative end*/

    /**Alternative start
       26 -27 0    Navigation -Routing
       26 -28 0    Navigation -NoRouting
       27 28 -26 0 Routing NoRouting -Navigation
       -27 -28 0   -Routing -NoRouting
       Alternative end*/
